...
ARCH		?=arm64
CROSS_COMPILE	?=/home/halcyon441/toolchain/gcc_linaro/bin/aarch64-linux-gnu-
...
CC              = /home/halcyon441/toolchain/clang/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE    ?= /home/halcyon441/toolchain/clang/bin/aarch64-linux-gnu-
