...
ARCH		?=arm64
CROSS_COMPILE	?=/home/deadmau5/toolchain/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
CC              = /home/deadmau5/toolchain/clang/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE    ?= /home/deadmau5/toolchain/clang/bin/aarch64-linux-gnu-
