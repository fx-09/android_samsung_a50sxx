...
ARCH		?=arm64
CROSS_COMPILE	?=/home/testpilot/toolchain/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
CC              = /home/testpilot/toolchain/clang-4639204/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE    ?= /home/testpilot/toolchain/linaro/bin/aarch64-linux-gnu-
